...
function Mime ( base ) {
	...
	var _add = function ( mimeTypeDef ) {
		return base.post( 'mimetype', null, mimeTypeDef );
	};
	...
	var get = function ( filter ) {
		...
		return base.get( 'mimetype/full', queryParams );
	};
	...
	var deleteById = function ( id ) {
		return base.delete( 'mimetype', id );
	};

	var _update = function ( id, mimeTypeDef ) {
		return base.put( 'mimetype', id, null, mimeTypeDef );
	};

	var createExport = function ( filePath ) {

		var defer = Q.defer();
		base.get( 'mimetype/full' )
			.then( function ( data ) {
