...
function Extension ( base ) {
	...
	this.delete = function ( name ) {
		...
		base.delete( 'extension/name' + name ).then( function ( data ) {
	 ...
	 * @todo: appendPrivileges
	 */
	var upload = function ( zipFilePath, zipPassword ) {
		var defer = Q.defer();

		var params = [];
		if (zipPassword) {
			params.push({'key': 'pwd', 'value': zipPassword});
		}
		base.post( 'extension/upload', params)
				.then( function ( data ) {
